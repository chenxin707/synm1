...
use app\platformapi\lists\settings\UpgradeLists;
use app\platformapi\logic\settings\UpgradeLogic;
use app\platformapi\validate\settings\downloadPkgValidate;
use app\platformapi\validate\settings\UpgradeValidate;

/**
 * 系统更新
 * Class UpgradeController
 */
class UpgradeController extends BasePlatformController
{
    /**
     * @notes 查看系统更新列表
