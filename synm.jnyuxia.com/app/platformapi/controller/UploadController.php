...
class UploadController extends BasePlatformController
{
    /**
     * @notes 上传图片
     * @return Json
    ...
    public function image()
    {
        try {
            ...
            $result = UploadService::image($cid,$this->platformAdminId);
    ...
    public function video()
    {
        try {
            $cid = $this->request->post('cid', 0);
            $result = UploadService::video($cid,$this->platformAdminId);
            return $this->success('上传成功', $result);
        } catch (Exception $e) {
            return $this->fail($e->getMessage());
        }
