...
trait DuokaiSoftDelete
{
     ...
     * 删除当前的记录(多开改动)
     * @access public
     * @param  bool $scopeOpen 是否开启全局查询范围
     * @return bool
     */
    public function duokaiDelete(bool $scopeOpen = true): bool
    {
        ...
        if ($name && !$force) {
            ...
            $result = $this->exists()->withEvent(false)->duokaiSave([], null, $scopeOpen, false);
     ...
     * @return bool
     */
    public static function duokaiDestroy($data, bool $force = false, bool $scopeOpen = true): bool
    {
        ...
        foreach ($resultSet as $result) {
            $result->force($force)->duokaiDelete($scopeOpen);
        }
