...
class RoleLogic extends BaseLogic
{
    ...
    public function add(array $params)
    {
        ...
        try{
            ...
            $role->duokaiSave();
            //处理规格值
            array_walk($authKeys, function (&$auth) use ($role){
                $auth = ['auth_key'=>$auth, 'role_id' => $role->id];
            });

            (new RoleAuthIndex())->duokaiSaveAll($authKeys);
    ...
    public function edit(array $params)
    {
        Db::startTrans();
        try{
            RoleAuthIndex::where(['role_id'=>$params['id']])->useSoftDelete('delete_time',time())->useSoftDelete('delete_time', time())->delete();
            ...
            (new RoleAuthIndex())->duokaiSaveAll($authKeys, true, false, true);
    ...
    {
        Role::duokaiDestroy(['id'=>$params['id']]);
        (new AdminAuthCache())->deleteTag();
        return true;
    }
