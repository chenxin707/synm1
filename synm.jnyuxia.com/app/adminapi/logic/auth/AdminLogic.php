...
class AdminLogic extends BaseLogic
{
    ...
    {
        return Admin::field('account,name,root,role_id,disable,multipoint_login,avatar')->find($params['id'])->toArray();
    }
